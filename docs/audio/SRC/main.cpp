...
{
    cout<<prog<<": CLI tool for voice enhancement"<<endl;
    cout<<"Usage: "<<prog<<" options"<<endl;
    cout<<"-i filename: input file (required unless there is a config"<<endl;
    cout<<"-o outputfile: output file"<<endl;
    cout<<"-f format: format (default mp3)"<<endl;
    cout<<"-c configfile: config file for parameters"<<endl;
    cout<<"-v: 0 for no change (default), 1 for change"<<endl;
    cout<<"-z inputvoice (male/female/autodetect)"<<endl;
    cout<<"-m outputvoice (male/female)"<<endl;
    cout<<"-t tempo (same/slowdown/speedup)"<<endl;
    cout<<"-s style (same/soft/excitable)"<<endl;
}
...
int main( int argc, char **argv )
{
    ...
    argmod.ifilename = false;
    argmod.format = false;
    argmod.cfilename = false;
    argmod.changevoice = false;
    argmod.inputvoice = false;
    argmod.outputvoice = false;
    argmod.tempo = false;
    argmod.style = false;
